...
export const proposeMirrorAutomationTool = createTool({
  id: 'propose-mirror-automation',
  description:
    'Check for an equivalent Mirror watch, then create a DRAFT only when none exists or the user explicitly requested another.',
