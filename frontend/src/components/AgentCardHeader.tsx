  ...
  return (
    <div className="relative flex items-center gap-3">
      ...
      {href && (
        <Link
          to={href}
          className="group ml-auto inline-flex min-h-11 shrink-0 items-center gap-2 rounded-[4px] border-2 border-ink-600 bg-ink-800 px-3 py-2 text-sm font-medium text-gold-300 transition-colors hover:border-gold-500 hover:bg-ink-700 hover:text-heading"
        >
          Open agent <span className="fx-arrow" aria-hidden="true">→</span>
        </Link>
      )}
    </div>
  );
